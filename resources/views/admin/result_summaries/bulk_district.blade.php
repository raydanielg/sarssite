...
@section('title', 'Bulk Upload Summaries za Wilaya')
@section('page_title', 'Bulk Upload Summaries za Wilaya')

@section('content')
<div class="card card-outline card-primary shadow-sm border-0">
    <div class="card-header bg-white py-3">
        <h3 class="card-title font-weight-bold">
            <i class="fas fa-layer-group mr-2 text-primary"></i> Bulk Upload Summaries za Wilaya
        </h3>
    ...
    <div class="card-body">
        <div class="alert alert-info">
            <i class="fas fa-info-circle mr-1"></i> Hii sehemu ni kwa ajili ya <strong>Summary za Wilaya</strong> tu. Kwa summary za Mkoa tumia <a href="{{ route('admin.region-summaries.bulk-form') }}" class="alert-link">page ya Mkoa</a>.
        </div>
        ...
        <form id="bulkUploadForm">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="result_title_id">Target Examination Category (Wilaya)</label>
            ...
            <div id="filePreviewContainer" class="mt-4 d-none">
                ...
                <div class="text-right mt-4">
                    ...
                    <button type="submit" id="uploadBtn" class="btn btn-primary px-5 shadow-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="progress mb-3" style="height: 10px;">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" id="summaryOverallProgressBar" role="progressbar" style="width: 0%"></div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="doneSummaryUploadsBtn" style="display:none;">Done</button>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    function uploadSingleFile(queueItem) {
        return new Promise((resolve, reject) => {
            ...
            $.ajax({
                url: "{{ route('admin.district-summaries.bulk-upload') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    async function startUploadsFast() {
        ...
        Swal.fire({
            title: 'Success!',
            text: `${doneCount} district summaries uploaded successfully.`,
            icon: 'success'
        }).then(() => {
            window.location.href = "{{ route('admin.result-summaries.index', ['type' => 'district']) }}";
        });
    }
