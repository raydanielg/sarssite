...
<div class="card card-outline card-primary shadow border-0 rounded-lg overflow-hidden">
    <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%);">
        <h3 class="card-title font-weight-bold mb-0">
            <i class="fas fa-layer-group mr-2"></i> Bulk Upload Summaries za Wilaya
        </h3>
    ...
    <div class="card-body p-4">
        <div class="alert alert-info border-0 rounded-lg d-flex align-items-center">
            ...
            <div>
                Hii sehemu ni kwa ajili ya <strong>Summary za Wilaya</strong> tu. Kwa summary za Mkoa tumia <a href="{{ route('admin.region-summaries.bulk-form') }}" class="alert-link font-weight-bold">page ya Mkoa</a>.
            </div>
        </div>
